...
export const DEFAULT_CATS: Category[] = [
  ...
  { id: 'amzn',  name: 'Amazon Prime', color: '#00A8E0', ico: '📦', kind: 'gasto', budget: 5   },
  { id: 'hbo',   name: 'HBO Max',      color: '#7B2FBE', ico: '🎭', kind: 'gasto', budget: 9   },
...
export const SEED_TX: Transaction[] = [
  ...
  { id: 't5',  name: 'Netflix',        catId: 'nflx',  date: daysAgo(2), amt: -12.99 },
